function updateUserTable(){
  ...
  PythonShell.run("userTable.py", options, function (err, results) {
    ...
    for(i=0; i<results.length; i+=3){
       ...
       cell3.innerHTML = '<p id="permisos" class="pill-white btn"><a id="'+ usuario +'" style="color: black" href="#">Ver permisos</a></p>'
       cell4.innerHTML = '<p class="btn"><i class="glyphicon glyphicon-trash" id="'+ usuario +'" style="font-size:15px;color:black" onclick="confirmacion(this.id);"></i></p>'
    }
  });
}
